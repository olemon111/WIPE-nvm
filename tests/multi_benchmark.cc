...
int main(int argc, char** argv) {
  ...
  if (use_data_file) {
    //std::string filename = "/home/zzy/lognormal-190M.bin.data";
    //std::string filename = "/home/zzy/generate_random_ycsb.dat";
    std::string filename = "/home/zzy/generate_random_osm_longlat.dat";
    //std::string filename = "/home/zzy/generate_random_osm_longtitudes.dat";
