...
std::vector<T> load_data_from_osm(
    const std::string dataname = "/home/zzy/generate_random_osm_longlat.dat")
{
...
int main(int argc, char **argv)
{
  ...
  {
  case 0:
    key = load_data_from_osm<uint64_t>("/home/zzy/generate_random_osm_longtitudes.dat");
    break;
  case 1:
    key = load_data_from_osm<uint64_t>("/home/zzy/generate_random_osm_longlat.dat");
    break;
  case 2:
    key = load_data_from_osm<uint64_t>("/home/zzy/lognormal.dat");
    break;
  case 3:
    key = load_data_from_osm<uint64_t>("/home/zzy/generate_random_ycsb.dat");
    break;
  default:
